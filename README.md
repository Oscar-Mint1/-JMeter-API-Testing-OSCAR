...
Висновки:
При тестування продуктивності API JSONPlaceholder виявлено точку, де відбувається перенавантаження серверу, це 501 users. Для методу POST ця кількість була достатньою, щоб API серверу видало помилку 0.01%, але всі інші запити показали значення 0.00%. При повторному проведені стрес-тесту сервер виконав усі запити без помилок. 
